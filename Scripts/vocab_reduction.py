...
print "Reducing and copying the initial 3 matrices"
...
# load 3rd, 4th, 5th, 6th, 7th and 8th matrix separately and reduce them
for i in range(3,9):
...
print "Time to load first 2 visual words matrices: " + str(t2-t1)
